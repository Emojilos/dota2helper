 ...
 * loadCompactPanelContent → compact-panel). Роутинг не через react-router —
 * сейчас всего два «маршрута», полноценный роутер был бы лишней абстракцией.
 */
const windowKind = new URLSearchParams(window.location.search).get('window')
const RootComponent = windowKind === 'compact-panel' ? CompactPanel : App
